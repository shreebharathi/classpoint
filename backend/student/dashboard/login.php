...
//Email Validation
  ...
  // Validate password
      ...
      } elseif(strlen(trim($_POST['stdpwd'])) < 4){
	...
	$sql = "SELECT * FROM `student` WHERE `std_email`='$email' AND `std_pwd`='$password'";
...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand-center" href="#"><h3>Student Login</h3></a>
    <ul class="navbar-nav">
      <li class="nav-item">
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="../../../img/person.png" class="icon w-2" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
      <input type="email" id="stdemail" class="fadeIn second" name="stdemail" placeholder="email id">
      <input type="password" id="stdpwd" class="fadeIn third" name="stdpwd" placeholder="password">
      <input type="submit" class="fadeIn fourth" value="Log In" name="login">
      <span><?php if(!empty($msg)) echo $msg;?></span>
      <p class="text-center text-muted mt-5 mb-0">Don't have an account? 
        <a href="signup.php" class="fw-bold text-body"><u>Click here to Signup</u></a></p>
    </form>
