...
<div class="container-fluid mt-5">
        ...
        $sql="SELECT * From announcement,branch,teacher WHERE announcement.tch_id=teacher.tch_id AND announcement.branch_id=branch.branch_id AND announcement.std_sem=$sem";
        ...
        <tr style="text-align:center;">
            ...
            <td><?php echo "<a href='submitt.php?id=$row[announce_id]&tch_id=$row[tch_id]'>" . $row['announce_id'] . "</a> "; ?></td>
