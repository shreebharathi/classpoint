...
//Email Validation
  ...
  // Validate password
      ...
      } elseif(strlen(trim($_POST['admin_pwd'])) < 4){
...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand-center" href="#"><h3>Admin Login</h3></a>
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link active" href="../../../index.php"><h3>Home</h3></a>
      </li>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
      ...
      <input type="password" id="admin_pwd" class="fadeIn third" name="admin_pwd" placeholder="password">
