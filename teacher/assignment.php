...
<div class="container-fluid mt-5">
              ...
              <div class="table-responsive table-bordered border-dark">
                <table class="table border-dark" id="dataTable" width="100%" cellspacing="0">
                  <thead class="table table-dark">
                        ...
                        <?php
                        $sql="SELECT * From assignmnt,announcement,branch,student WHERE assignmnt.tch_id='$tch_id' AND announcement.branch_id=branch.branch_id AND assignmnt.announce_id=announcement.announce_id AND assignmnt.std_id=student.std_id";
        ...
        <tr style="text-align:center;">
            ...
            <td><?php echo $row['as_file'];?></a></td>
            <td><?php echo $row['as_desc'];?></td>
            <td><?php echo $row['std_name'];?></td>
            <td><?php echo $row['subject'];?></td>
            <td><?php echo $row['std_sem'];?></td>
            <td><?php echo $row['branch_name'];?></td>
            <td><?php echo $row['as_status'];?></td>
            <td><?php echo $row['timestamp'];?></td>
            <td><a href="download.php?id=<?php echo $row ['as_id']?>" class="btn btn-primary" download>Download</a></td>
            <td><button type="button"><a href="feedback.php?as_id=<?php echo $row['as_id'];?>&std_id=<?php echo $row['std_id'];?>" class="btn btn-primary">
