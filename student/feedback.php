...
<div class="container-fluid mt-5">
        ...
        $sql="SELECT * From feedback,assignmnt,teacher,student WHERE assignmnt.tch_id=feedback.tch_id AND feedback.std_id=student.std_id AND feedback.std_id='$user_id' AND feedback.tch_id=teacher.tch_id AND assignmnt.as_id=feedback.as_id";
